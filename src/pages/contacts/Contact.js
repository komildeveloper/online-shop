...
import call from '../../assets/img/call-icon.svg'
  ...
  return (
    <div className="contact d-flex align-items-start justify-content-between">
        ...
        <div className="left-top">
          ...
          <div className=" d-flex align-items-center">
            ...
            <div className="location">
              <p className="loc-desc m-0 fw-bold">
                {dataContact[lang]?.content2}
              </p>
      ...
      <div className="contact-right d-flex flex-column">
        <a
          className=" socialLink text-decoration-none mb-3"
          target="_blank"
          href="https://vk.com/"
        >
          <img src={vk} alt="vk icon" width="50" height="50" />
        </a>
        <a
          className=" socialLink text-decoration-none mb-3"
          target="_blank"
        ...
        >
          <img src={insta} alt="insta icon" width="50" height="50" />
        </a>
        <a
          className=" socialLink text-decoration-none mb-3"
          target="_blank"
        ...
        >
          <img src={telegram} alt="telegram icon" width="50" height="50" />
        </a>
        <a
          className=" socialLink text-decoration-none mb-3"
          target="_blank"
        ...
        >
          <img src={wApp} alt="wApp icon" width="50" height="50" />
        </a>
      </div>
    </div>
  )
